...
void check()
    {
        if (player[0][0]==player[0][1]==player[0][2] || player[1][0]==player[1][1]==player[1][2] || player[2][0]==player[2][1]==player[2][2] || player[0][0]==player[1][1]==player[2][2] || player[0][2]==player[1][1]==player[2][0])
        {
